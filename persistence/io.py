...
Usage::
    ...
    from persistence.io import read_vector, write_vector, detect_format, dataset_from_file
...
from core.models import Dataset, DataCategory
...
def write_vector(
    ...
    **kwargs: Any,
    ...
    if write_style_sidecars:
        try:
            from persistence.style_sidecar import write_style_sidecars as _write_sidecars
