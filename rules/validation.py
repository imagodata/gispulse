...
from core.models import AnyPredicate, AttrPredicate, CompoundPredicate, GeomPredicate, Rule, Trigger, TriggerEvent


def _ensure_capabilities_registered() -> None:
    """Lazily register default capabilities if the registry is empty."""
    if not REGISTRY:
        import capabilities.vector  # noqa: F401, PLC0415
