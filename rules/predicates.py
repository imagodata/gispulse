...
from core.models import AnyPredicate, AttrPredicate, CompoundPredicate, GeomPredicate
from core.sql_safety import validate_identifier as _safe_ident, validate_ref_filter
...
class ShapelyPredicateEvaluator:
    ...
    def evaluate(
        ...
        import time
        try:
            from core.models import EvalResult, SpatialState
        except ImportError:
