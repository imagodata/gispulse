...
|---|---|---|---|---|---|
| `add_field` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_capability_execute_safe.py) | ✅ | — | — |
...
| `area_length` | [centroid_area.py](../../../src/gispulse/capabilities/vector/centroid_area.py) | [✅](../../../tests/unit/test_capabilities.py) | ✅ | ✅ | ✅ |
...
| `attribute_join` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_beta_fixes_2026_04_24.py) | ✅ | — | — |
...
| `boundary` | [boundary.py](../../../src/gispulse/capabilities/vector/boundary.py) | [✅](../../../tests/unit/test_layer_transform_capabilities.py) | ✅ | — | — |
| `buffer` | [buffer.py](../../../src/gispulse/capabilities/vector/buffer.py) | [✅](../../../tests/unit/test_capabilities.py) | — | — | ✅ |
| `calculate` | [calculate.py](../../../src/gispulse/capabilities/vector/calculate.py) | [✅](../../../tests/unit/test_calculate_capabilities.py) | ✅ | ✅ | ✅ |
| `case_when` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_attr_logic_capabilities.py) | ✅ | — | — |
| `cast_field` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_schema_capabilities.py) | ✅ | — | — |
| `centroid` | [centroid_area.py](../../../src/gispulse/capabilities/vector/centroid_area.py) | [✅](../../../tests/unit/test_capabilities.py) | ✅ | — | ✅ |
...
| `coalesce_fields` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_attr_logic_capabilities.py) | ✅ | — | — |
| `completeness_check` | [validation.py](../../../src/gispulse/capabilities/validation.py) | [✅](../../../tests/unit/test_capabilities_validation.py) | ✅ | — | ✅ |
| `concave_hull` | [concave_hull.py](../../../src/gispulse/capabilities/vector/concave_hull.py) | [✅](../../../tests/unit/test_advanced_vector_capabilities.py) | ✅ | — | ✅ |
...
| `convex_hull` | [shape_ops_basic.py](../../../src/gispulse/capabilities/vector/shape_ops_basic.py) | [✅](../../../tests/unit/test_new_vector_capabilities.py) | ✅ | — | — |
| `deduplicate` | [selection.py](../../../src/gispulse/capabilities/selection.py) | [✅](../../../tests/unit/test_selection_capabilities.py) | ✅ | — | — |
...
| `dissolve` | [dissolve.py](../../../src/gispulse/capabilities/vector/dissolve.py) | [✅](../../../tests/unit/test_capabilities.py) | ✅ | — | ✅ |
| `drop_field` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_schema_capabilities.py) | ✅ | — | — |
...
| `envelope` | [shape_ops_basic.py](../../../src/gispulse/capabilities/vector/shape_ops_basic.py) | [✅](../../../tests/unit/test_new_vector_capabilities.py) | ✅ | — | — |
| `erase` | [overlay.py](../../../src/gispulse/capabilities/overlay.py) | [✅](../../../tests/unit/test_overlay_capabilities.py) | ✅ | — | — |
...
| `make_valid` | [shape_ops_basic.py](../../../src/gispulse/capabilities/vector/shape_ops_basic.py) | [✅](../../../tests/unit/test_new_vector_capabilities.py) | ✅ | — | ✅ |
...
| `nearest_neighbor` | [nearest.py](../../../src/gispulse/capabilities/vector/nearest.py) | [✅](../../../tests/unit/test_new_vector_capabilities.py) | — | ✅ | ✅ |
...
| `overlay_intersection` | [overlay.py](../../../src/gispulse/capabilities/overlay.py) | [✅](../../../tests/unit/test_overlay_capabilities.py) | ✅ | — | — |
...
| `rename_field` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_schema_capabilities.py) | ✅ | — | — |
| `reproject` | [reproject.py](../../../src/gispulse/capabilities/vector/reproject.py) | [✅](../../../tests/unit/test_capabilities.py) | — | — | ✅ |
| `reverse_lines` | [transforms.py](../../../src/gispulse/capabilities/transforms.py) | [✅](../../../tests/unit/test_transforms_capabilities.py) | ✅ | — | — |
| `select_columns` | [schema.py](../../../src/gispulse/capabilities/schema.py) | [✅](../../../tests/unit/test_schema_capabilities.py) | ✅ | — | — |
| `shortest_path` | [network.py](../../../src/gispulse/capabilities/network.py) | [✅](../../../tests/unit/test_network_capabilities.py) | ✅ | — | — |
| `simplify` | [simplify.py](../../../src/gispulse/capabilities/vector/simplify.py) | [✅](../../../tests/unit/test_advanced_vector_capabilities.py) | ✅ | — | — |
...
| `sort` | [selection.py](../../../src/gispulse/capabilities/selection.py) | [✅](../../../tests/unit/test_selection_capabilities.py) | ✅ | — | — |
| `spatial_aggregate` | [aggregate.py](../../../src/gispulse/capabilities/vector/aggregate.py) | [✅](../../../tests/unit/test_calculate_capabilities.py) | — | ✅ | ✅ |
| `spatial_join` | [spatial_join.py](../../../src/gispulse/capabilities/vector/spatial_join.py) | [✅](../../../tests/unit/test_capabilities.py) | — | — | ✅ |
...
| `symmetric_difference` | [diff.py](../../../src/gispulse/capabilities/vector/diff.py) | [✅](../../../tests/unit/test_density_and_advanced_vector_capabilities.py) | ✅ | — | — |
| `temporal_filter` | [temporal.py](../../../src/gispulse/capabilities/temporal.py) | [✅](../../../tests/unit/test_temporal_capabilities.py) | ✅ | — | — |
| `temporal_join` | [temporal.py](../../../src/gispulse/capabilities/temporal.py) | [✅](../../../tests/unit/test_temporal_capabilities.py) | ✅ | — | — |
| `top_n` | [selection.py](../../../src/gispulse/capabilities/selection.py) | [✅](../../../tests/unit/test_beta_fixes_2026_04_24.py) | ✅ | — | — |
| `topology_check` | [validation.py](../../../src/gispulse/capabilities/validation.py) | [✅](../../../tests/unit/test_capabilities_validation.py) | ✅ | — | ✅ |
| `union` | [union.py](../../../src/gispulse/capabilities/vector/union.py) | [✅](../../../tests/unit/test_capabilities.py) | ✅ | — | ✅ |
