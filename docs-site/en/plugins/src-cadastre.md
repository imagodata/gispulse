...
|-------------|-----------------------------|----------------|-----------------------------------|-------------------------------------------------|---------|--------------|
| `parcelles` | Cadastral parcels           | `WFS`          | `https://data.geopf.fr/wfs/ows`   | `CADASTRALPARCELS.PARCELLAIRE_EXPRESS:parcelle` | VECTOR  | FR           |
| `communes`  | Cadastral communes          | `WFS`          | `https://data.geopf.fr/wfs/ows`   | `CADASTRALPARCELS.PARCELLAIRE_EXPRESS:commune`  | VECTOR  | FR           |
| `batiments` | Cadastral buildings         | `WFS`          | `https://data.geopf.fr/wfs/ows`   | `CADASTRALPARCELS.PARCELLAIRE_EXPRESS:batiment` | VECTOR  | FR           |
...
- Upstream issue: [#184](https://github.com/imagodata/gispulse/issues/184) (pilot wave 1 — `DeclarativeSource` contract)
