...
def _to_pipeline_spec(steps: list[StepSpecIn], name: str = "", description: str = "",
    ...
    from gispulse.core.pipeline import PipelineSpec, StepSpec, TriggerSpec
...
def _validate_pipeline(steps: list[StepSpecIn], ref_layers: dict[str, str] | None = None) -> list[ValidationIssue]:
    ...
    from gispulse.capabilities import list_all as list_capabilities
...
def execute_pipeline_steps(
    ...
    import json
    from gispulse.capabilities import get as get_capability
...
def list_examples() -> list[PipelineExampleOut]:
    ...
    from gispulse.core.pipeline import pipeline_to_dict
