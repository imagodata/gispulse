...
from gispulse.core.models import ChangeOperation, ChangeRecord, Trigger
...
class ChangeLogWatcher:
    ...
    def _load_row_values(self, table: str, fid: str) -> dict[str, Any] | None:
        ...
        """
        from gispulse.core.sql_safety import validate_identifier as _validate_ident
    ...
    def _dispatch_fired(
        ...
        *,
        ...
        try:
            ...
            from gispulse.core.models import EvalResult
